...
<head>
    ...
    <title>Purchase Form | Book Store</title>
...
<div class="container">
    ...
    <div class="col-md-8 mx-auto border">
	    <div class="bg-light p-3 mb-3"><h4>Add Purchase</h4></div>
		    ...
		    <form:form method="post" action="save" class="p-3">
			    ...
			    <div class="mb-3">
				  <label for="books" class="form-label">Books Purchased</label>
				  <form:textarea class="form-control" rows="4" placeholder="Write name of books purchased by the customer" path="books" />
				</div>
			    <div class="mb-3">
				  <label for="quantity" class="form-label">Total Quantity</label>
				  <form:input class="form-control" placeholder="Total Quantity" path="quantity" />
				</div>
