...
<body>
   ...
   <h4 class="p-3">Manage Books</h4>
   <a class="btn btn-primary" href="bookform">+ Add New Book</a>
   </div>
   <br>
   <br>
		  ...
		  <c:forEach var="book" items="${list}"> 
		    <tr>
		      ...
		      <td>${book.description}</td>
			   <td>
			   <a class="btn btn-sm btn-outline-primary" href="editbook/${book.id}">Edit</a>
			   <a class="btn btn-sm btn-outline-danger" href="deletebook/${book.id}">Delete</a>
			   </td> 
		    </tr>
		    </c:forEach>
		  </tbody>
