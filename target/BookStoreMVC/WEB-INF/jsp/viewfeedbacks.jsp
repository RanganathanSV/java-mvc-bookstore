...
<meta charset="ISO-8859-1">
    ...
    <title>Feedbacks | Book Store</title>
...
<body>
   ...
   <h4 class="p-3">Manage Feedbacks</h4>
   <a class="btn btn-primary" href="feedbackform">+ Add New Feedback</a>
   </div>
   <br>
   <br>
		  ...
		  <c:forEach var="feedback" items="${list}"> 
		    <tr>
		      ...
		      <td>${feedback.feedback}</td>
			   <td>
			   <a class="btn btn-sm btn-outline-danger" href="deletefeedback/${feedback.id}">Delete</a>
			   </td> 
		    </tr>
		    </c:forEach>
		  </tbody>
